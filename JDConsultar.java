...
public class JDConsultar extends JDialog {
	...
	public static void main(String[] args) {
		try {
			JDConsultar dialog = new JDConsultar();
	...
	public JDConsultar() {
		...
		JLabel lblGarantaaos = new JLabel("Garant\u00EDa (a\u00F1os)");
		lblGarantaaos.setFont(new Font("Microsoft YaHei", Font.PLAIN, 13));
		lblGarantaaos.setBounds(21, 71, 100, 14);
		contentPanel.add(lblGarantaaos);
		
		JLabel lblTamao = new JLabel("Tama\u00F1o");
		lblTamao.setFont(new Font("Microsoft YaHei", Font.PLAIN, 13));
		lblTamao.setBounds(21, 96, 100, 14);
